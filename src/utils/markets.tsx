...
export const MarketContext: React.Context<null | MarketContextValues> = React.createContext<null | MarketContextValues>(
  null,
);
...
export function MarketProvider( props: any) {
  const { marketAddress, setMarketAddress, children } = props;
  ...
  useEffect(() => {
    ...
    if (!marketInfo || !marketInfo.address) {
      ...
      console.log('Please select a market from the dropdown')
      return;
//added else
    } else {
